...
class VisualizationDemo:
    def __init__(self, cfg, vis_highest_scoring=True, output_dir="./vis", im_name=""):
        """
        Args:
            cfg (CfgNode):
    ...
    def visualize_prediction(
        ...
        save_file = os.path.join(self.output_dir, "%s.obj" % im_name)
...
if __name__ == "__main__":
    ...
    demo = VisualizationDemo(
        cfg, vis_highest_scoring=args.onlyhighest, output_dir=args.output, im_name=im_name
    )
